...
export { sortMessagesChronological } from "./utils";
...
export const chatService = {
  ...
  markDirectMessageRead: async (messageId: number): Promise<void> => {
    await api.post<void>(API_ENDPOINTS.CHATS.DIRECT_MESSAGE_READ(messageId), {});
  },
};
